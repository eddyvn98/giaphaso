...
export const MOCK_PEOPLE: Person[] = [
  ...
  { id: 'chau-sau-2', fullName: 'Hà Thị Vân Anh', gender: 'female', isAlive: true, order: 4, images: [] },
  { id: 'chau-sau-3', fullName: 'Hà Minh Thông', gender: 'male', isAlive: true, order: 4, images: [] },
